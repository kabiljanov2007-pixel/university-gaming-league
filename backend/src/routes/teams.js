...
router.post('/register',
  [
    ...
    body('contactName').trim().notEmpty().withMessage('Введите имя и фамилию капитана'),
    ...
    body('members.*.name').trim().notEmpty().withMessage('Укажите имя и фамилию каждого игрока'),
