...
const disciplines = [
  {
    ...
    rules: [
      ...
      'Все игроки обязаны быть подписаны на @univer.mnu в Instagram',
      'Если участник не подписан на Instagram турнира, команда получает автоматическую дисквалификацию',
    ],
    requirements: [
