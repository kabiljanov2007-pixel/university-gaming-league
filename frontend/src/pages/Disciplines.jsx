...
const disciplines = [
  {
    ...
    rounds: '3 матча в группе + финал',
    duration: '~6 часов',
    rules: [
      'Команды состоят из 4 игроков',
      'Карты: Erangel, Miramar — выбор по жеребьёвке',
      'Точки начисляются за место + количество убийств',
      'Запрещён буст и использование читов',
      'Устройства должны быть одобрены организаторами',
      'Финальный матч — карта Erangel',
    ],
    requirements: [
      'Аккаунт уровня не ниже 30',
      'Студент университета Кыргызстана',
      'Наличие собственного смартфона/планшета',
  ...
  },
  {
    ...
    rules: [
      'Команды состоят из 4 игроков',
      'Персонажи и питомцы — по договорённости',
      'Все игроки используют личные аккаунты',
      'Запрещены модифицированные APK файлы',
      'Система точек: место + фраги',
      'Финальный матч на карте Bermuda',
    ],
    requirements: [
      'Аккаунт уровня не ниже 20',
      'Студент университета Кыргызстана',
      'Наличие смартфона Android/iOS',
      'Согласие с правилами турнира',
    ],
