    ...
    questions: [
      {
        ...
        a: 'Участвовать могут студенты и выпускники 11-го класса.',
      },
      {
      ...
      },
      {
        ...
        a: 'Регистрация открыта с 14 по 20 мая 2026 года включительно. Заявки, поданные после 23:59 20 мая, не рассматриваются.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Турнир проходит офлайн в большом актовом зале Университета им. К.Ш. Токтоматова.',
      },
      {
      ...
      },
      {
        ...
        a: 'Турнир состоится 22 мая 2026 года. В 09:30 — регистрация участников на месте, в 10:00 — начало турнира.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Победители получают дипломы, медали, кубки и специальную награду (Surprise).',
      },
      {
        q: 'Когда и где пройдёт церемония награждения?',
        a: 'Церемония награждения состоится 22 мая 2026 года сразу после финальных матчей в большом актовом зале Университета им. К.Ш. Токтоматова.',
      },
    ],
  },
]
            ...
            <div className="faq-sidebar">
              ...
              <div className="faq-register-card">
                ...
                <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)', marginBottom: 16, lineHeight: 1.6 }}>
                  Регистрация команд открыта с 14 по 20 мая 2026!
                </p>
